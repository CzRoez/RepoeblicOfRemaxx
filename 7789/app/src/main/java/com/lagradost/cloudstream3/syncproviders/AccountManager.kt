...
abstract class AccountManager {
    companion object {
        ...
        const val APP_STRING = "cloudztreamapp"
        const val APP_STRING_REPO = "cloudztreamrepo"
        const val APP_STRING_PLAYER = "cloudztreamplayer"

        // Instantly start the search given a query
        const val APP_STRING_SEARCH = "cloudztreamsearch"

        // Instantly resume watching a show
        const val APP_STRING_RESUME_WATCHING = "cloudztreamcontinuewatching"
