...
class KotakAnimeidEmbed : Hxfile() {
    override val name = "KotakEmbed"
    override val mainUrl = "https://embed2.kotakanimeid.link"
    override val requiresReferer = true
}

class Nontonanimeid : Hxfile() {
    override val name = "NontonAnimeId"
    override val mainUrl = "https://nontonanimeid.cyou"
    override val requiresReferer = true
}
